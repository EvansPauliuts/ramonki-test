...
//         const nameLocator = this.page.locator(this.locators.productName).first();
//         return await nameLocator.textContent();
//     }
//
//     async getProductPrice() {
//         const priceLocator = this.page.locator(this.locators.productPrice).first();
//         return await priceLocator.textContent();
//     }
//
//     async getProductSize() {
//         const sizeLocator = this.page.locator(this.locators.productSize).first();
...
//         await this.page.locator(this.locators.sizeSelector).first().click();
